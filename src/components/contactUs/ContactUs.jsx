          ...
          {cards.map((card, index) => {
            return (
              ...
              >
                ...
                <p className=" text-[.45rem] leading-[.5rem] mobile:text-[.5rem] mobile:leading-[.6rem] lmobile:text-[.6rem] lmobile:leading-[.7rem] sm:text-[.7rem] sm:leading-[.8rem] md:pt-2 md:text-[.8rem] md:leading-4 lg:text-[1rem] lg:leading-5">
                  {card.content}
                </p>
              </li>
            );
