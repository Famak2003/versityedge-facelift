  ...
  return (
    <section className=" generalPadding flex flex-col gap-[2rem] sm:gap-[3rem] md:gap-[4rem]">
      ...
      <div className=" flex gap-[5rem]">
        <Button addstyle=" ring-inset py-[.2rem] sm:py-[.7rem] md:py-[1rem] bg-white ring-1 ring-[var(--blue-texture)]   text-[.8rem] mobile:text-[.9rem] lmobile:text-[1.2rem] sm:text-[1.4rem] md:text-[1.8rem] lg:text-[2rem]">
          Course
        </Button>
