    ...
    return (
        ...
        <div className="flex flex-col items-center justify-start gap-[40px]">
          ...
          <div className="relative w-[391px] h-[87px] text-base">
            ...
            <Link to='/password2'>
            <div className="absolute top-[0px] left-[60px] rounded-2xl bg-primary-blue-1 box-border w-[270px] overflow-hidden flex flex-row items-center justify-center py-[11px] px-[24px] text-center text-xl text-primary-white-1 border-[1px] border-solid border-primary-blue-1 lmobile:w-[391px] lmobile:left-[0px]">
