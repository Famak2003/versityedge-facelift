    ...
    return (
        ...
        <form onSubmit={handleSubmit} className="flex flex-col items-center justify-start gap-[40px]">
          <div className="relative w-[475px] h-[139px] text-center">
            ...
            <div className="absolute top-[73px] left-[90px] right-[90px] text-5xl font-light lmobile:left-[0px] lmobile:right-[0px]">
              <p className="m-0">Enter phone number to reset password +23481 27*** 98/</p>
            </div>
          </div>
