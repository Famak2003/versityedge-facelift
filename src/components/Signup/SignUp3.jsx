        ...
        <div className="flex flex-col items-center justify-start gap-[40px] text-left text-29xl text-black">
          ...
          <div className="relative w-[391px] h-[87px] text-base">
           ...
           <div className="absolute top-[65px] left-[0.5px] font-light">
            ...
            <Link to="/congrats1">
            <div className="absolute top-[0px] left-[64px] rounded-2xl bg-primary-blue-1 box-border w-[280px] overflow-hidden flex flex-row items-center justify-center py-[11px] px-[24px] text-xl text-primary-white-1 border-[1px] border-solid border-primary-blue-1 lmobile:w-[391px] lmobile:left-[0px]">
