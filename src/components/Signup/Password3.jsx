    ...
    return(
        ...
        <div className="flex flex-col items-center justify-start gap-[40px]">
          ...
          <div className="relative w-[391px] h-[146px] text-lg text-primary-black-7">
            <input type='password' placeholder='Enter password' className="absolute top-[0px] left-[60px] rounded-2xl bg-primary-white-1 box-border 
            ...
            <input type='password' placeholder='Re-enter password' className="absolute top-[91px] left-[60px] rounded-2xl bg-primary-white-1 box-border 
            w-[270px] h-[55px] px-[24px] text-black font-light outline-none overflow-hidden border-[1px] border-solid border-primary-black-7 lmobile:w-[391px] lmobile:left-[0px]" />
              {/* <div className="absolute top-[15px] left-[29px] font-light">
                Re-enter password
              </div>
          ...
          <div className="relative w-[391px] h-[49px] text-xl text-primary-white-1">
           <Link to='/congrats2'>
           <div className="absolute top-[0px] left-[60px] rounded-2xl bg-primary-blue-1 box-border w-[270px] overflow-hidden 
