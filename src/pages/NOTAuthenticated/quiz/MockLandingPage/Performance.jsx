      ...
      <div className=" flex justify-between items-center">
        ...
        <div className=" w-[45%] flex flex-col gap-[2rem]">
          <div className=" flex justify-between">
            <Button addstyle="Text16px py-[.7rem] text-[var(--blue)] px-[.4rem] bg-[white] ring-1 ring-[var(--blue)]">
              Strength
            </Button>
          ...
          <ul>
            {content.map((obj, idx) => (
              <li
                ...
                ref={accordion}
                key={idx}
                className=" flex pb-3 justify-between items-center Text24px border-b border-b-[var(--gray)]"
              >
                <p>{obj.subject}</p>
                <span className="">
                  <img
