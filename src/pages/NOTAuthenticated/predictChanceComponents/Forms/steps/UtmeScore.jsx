  ...
  return (
    <div className=" flex flex-col gap-[.5rem] mobile:gap-[1rem] sm:gap-[1.5rem] md:gap-[3rem]">
        ...
        <li className=" list-disc">
          <div className=" flex items-center gap-5">
            ...
            <select
              ...
              name="UTMEAttemps"
              id="UTMEAttemps"
              className="WCVCardHeader h-[2.8rem] w-[5rem] rounded-lg px-[1rem] ring-1 ring-[var(--gray)]"
            >
      ...
      <div className=" mt-5 flex flex-col gap-[1.5rem] mobile:gap-[1rem] sm:gap-[1.5rem] ">
        ...
        />
        <p className=" responsiveHeader text-[var(--gray)]">Other Settings</p>
    ...
    <div className=" flex flex-col gap-[1rem] smobile:flex-row smobile:items-center smobile:gap-[2rem] mobile:gap-[5rem]">
      ...
      <div className=" flex items-center gap-[1rem]">
        ...
        <select
          ...
          className=" WCVCardHeader h-[2.8rem] w-[7rem]  rounded-lg pl-[.5rem] ring-1 ring-[var(--gray)]"
        >
          {Years().map((yr, index) => {
            return (
