  ...
  return (
    <div className=" flex w-[100%] justify-between mobile:justify-around ">
      ...
      >
        <Button
          addstyle={
            "bg-white ring-1 Text24px ring-[var(--blue)] py-[.5rem] hover:bg-[var(--blue)] hover:text-white duration-500 ease-in-out"
          }
        >
          Back
        </Button>
      ...
      >
        <Button
          addstyle={
            " py-[.5rem] Text24px  text-white hover:bg-white hover:text-black ring-1 ring-[var(--blue)] duration-500 ease-in-out"
          }
        >
          Next
        </Button>
