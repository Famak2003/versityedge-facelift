...
const ForumHome = () => {
  const forumPosts = [
    ...
    {
      title:
        "Is it better to focus on my UTME score or my O'Level grades for admissions?",
      unilogo: "",
      content: `Varade euroll eurossade de kavan euronas ben prel. Hypotåbänar trebelt pagon och geoblockering som muhojangen. Mytofili kvasiledes ultranat, göra en labrador koktig. Senar nitrelingar: liksom disade, fårad minas. 
            Nyvaliga dinat mytogam tregt i vidade därför att bor om ontoism. Pabel mörade om än prona e-cigarett bärat låskade. Pogisk diar ekotologi buning ifall hemivis i pretånas. Sulig povos tevosa i kros antimisk och antitir sotelål. 
            Megabäl tijur yrade beledes oaktat svennekoloni suprajäk så målapp. Orostelefon disamma nilask, janalig ontoskop. Besuktig mikroning av degt: jejetenera nyck. Vibäl gåtåg sagisk homoplana direktare kravallturism jer. 
    ...
    {
      title:
        "Has anyone applied for Computer Science at UNILAG? What was your experience like?",
      unilogo: "",
      content: `Varade euroll eurossade de kavan euronas ben prel. Hypotåbänar trebelt pagon och geoblockering som muhojangen. Mytofili kvasiledes ultranat, göra en labrador koktig. Senar nitrelingar: liksom disade, fårad minas. 
            Nyvaliga dinat mytogam tregt i vidade därför att bor om ontoism. Pabel mörade om än prona e-cigarett bärat låskade. Pogisk diar ekotologi buning ifall hemivis i pretånas. Sulig povos tevosa i kros antimisk och antitir sotelål. 
            Megabäl tijur yrade beledes oaktat svennekoloni suprajäk så målapp. Orostelefon disamma nilask, janalig ontoskop. Besuktig mikroning av degt: jejetenera nyck. Vibäl gåtåg sagisk homoplana direktare kravallturism jer. 
  ...
  return (
    <div className="forum-home">
      <div className="forum-hero">
        <div className="text">
          <h1>
            Join a supportive community of fellow aspiring students and parents.
          </h1>
          <p>
            Welcome to VersityEdge's exclusive forum designed to empower you on
            your journey to secure admissions into your dream institution.
            Connect with like-minded individuals who understand the struggles
            and aspirations you're going through. Share your experiences, seek
            advice, and learn from the stories of others.
          </p>
          <Link to="/">
      ...
      <div className="forum-join-a-session">
        ...
        <div className="text">
          ...
          <p>
            VersityEdge is a dynamic space designed to serve both aspiring
            students and parents. Connect with like-minded individuals, share
            experiences, and access valuable advice that enhances your
            understanding of the admission process. Collaborate with other
            parents and students to make informed decisions and guide your
            admission journey effectively.
          </p>
          <Link>
