...
function OurStory() {
  return (
    <section className=" generalPadding flex flex-col items-center justify-center gap-[4rem] bg-[var(--lightblue)] py-[2rem] mobile:py-[3rem] md:py-[5rem] ">
          ...
          return (
            <li
              ...
              className={`flex h-[16rem] items-center justify-end mobile:h-[18rem] sm:h-[20rem] md:h-[23rem] ${
                index === 0
                  ? " border-b-[.03rem] border-r-[.03rem] border-[var(--gray)] pr-[1rem] mobile:pr-[3rem] md:pr-[5rem]"
                  : ""
              }${
                index === 1
                  ? "border-b-[0.03rem] border-[var(--gray)] pl-[1rem] mobile:pl-[3rem] md:pl-[5rem]"
                  : ""
              }${
                index === 2
                  ? " border-r-[.03rem] border-[var(--gray)] pr-[1rem] mobile:pr-[3rem] md:pr-[5rem]"
                  : ""
              }${
                index === 3
                  ? " border-[var(--gray)] pl-[1rem] mobile:pl-[3rem] md:pl-[5rem]"
                  : ""
              } `}
              style={{
                backgroundImage: `url(${
